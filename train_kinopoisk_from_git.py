...
if __name__ == '__main__':
    ...
    os.system('mlflow run https://github.com/ilapro53/skillbox_mlflow_train2_from_git.git --experiment-name=kinopoisk --docker-args network=mlflow-server_mlflow_net --build-image')